/**
 * Social links bar (adapted from Uiverse.io by david-mohseni).
 * Twitter → X (new logo + name); Instagram/Facebook unchanged.
 * Edit the URLs below to point at Lima's real accounts.
 */
const LINKS = {
    ...
    <ul className="socials">
      ...
      <li className="icon x">
        <a href={LINKS.x} target="_blank" rel="noreferrer" aria-label="X">
          ...
          <svg viewBox="0 0 24 24" height="1.3em" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
